...
function initModels(sequelize) {
  ...
  GioHang_Topping.belongsTo(GioHang, { as: "GioHang", foreignKey: "GioHangID"});
  GioHang.hasMany(GioHang_Topping, { as: "GioHang_Toppings", foreignKey: "GioHangID"});
  Food.belongsTo(Ingredient, { as: "Ingredient", foreignKey: "IngredientId"});
  Ingredient.hasMany(Food, { as: "Foods", foreignKey: "IngredientId"});
  FoodIngredient.belongsTo(Ingredient, { as: "Ingredient", foreignKey: "IngredientId"});
  Ingredient.hasMany(FoodIngredient, { as: "FoodIngredients", foreignKey: "IngredientId"});
  Warehouse.belongsTo(Ingredient, { as: "Ingredient", foreignKey: "IngredientId"});
  Ingredient.hasMany(Warehouse, { as: "Warehouses", foreignKey: "IngredientId"});
  InvoiceDetail.belongsTo(Invoice, { as: "Invoice", foreignKey: "InvoiceId"});
  Invoice.hasMany(InvoiceDetail, { as: "InvoiceDetails", foreignKey: "InvoiceId"});
  OrderDetails_Topping.belongsTo(OrderDetails, { as: "OrderDetail", foreignKey: "OrderDetailId"});
  OrderDetails.hasMany(OrderDetails_Topping, { as: "OrderDetails_Toppings", foreignKey: "OrderDetailId"});
  ...
  GioHang_Topping.belongsTo(Topping, { as: "Topping", foreignKey: "ToppingID"});
  Topping.hasMany(GioHang_Topping, { as: "GioHang_Toppings", foreignKey: "ToppingID"});
  OrderDetails.belongsTo(Topping, { as: "Topping", foreignKey: "ToppingId"});
  Topping.hasMany(OrderDetails, { as: "OrderDetails", foreignKey: "ToppingId"});
  OrderDetails_Topping.belongsTo(Topping, { as: "Topping", foreignKey: "ToppingId"});
  Topping.hasMany(OrderDetails_Topping, { as: "OrderDetails_Toppings", foreignKey: "ToppingId"});
  DeliveryAddresses.belongsTo(Users, { as: "User", foreignKey: "UserId"});
  Users.hasMany(DeliveryAddresses, { as: "DeliveryAddresses", foreignKey: "UserId"});
  ...
  Vouchers.hasMany(UserVouchers, { as: "UserVouchers", foreignKey: "VoucherId"});
